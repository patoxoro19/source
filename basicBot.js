...
(function () {
    ...
    /*window.onerror = function() {
        var room = JSON.parse(localStorage.getItem("Kamurke"));
        window.location = 'https://plug.dj/patoxoro' + room.name;
    };*/
    ...
    var botCreator = "patoxoro";
    var botMaintainer = "patoxoro"
    var botCreatorIDs = ["4343261", "4343261"];
    ...
    var basicBot = {
        ...
        settings: {
            ...
            motdEnabled: true,
            motdInterval: 6,
            motd: "Our discord channel: http://discord.gg/zwscANJ :innocent:",
            filterChat: false,
            ...
            fbLink: null,
            youtubeLink: null,
            website: "http://discord.gg/zwscANJ",
            intervalMessages: [],
            messageInterval: 5,
            songstats: true,
            commandLiteral: "!",
